...
var apiKey = _environments_environment__WEBPACK_IMPORTED_MODULE_3__["environment"].apiKey;
...
var NoticiasService = /** @class */ (function () {
    ...
    NoticiasService.prototype.getTopHeadlines = function () {
        this.headlinesPage++;
        return this.ejecutarQuery("/top-headlines?country=mx&page=" + this.headlinesPage);
    };
    ...
    NoticiasService.prototype.setNoticia = function (noticia) {
        this.noticia = noticia;
    };
    NoticiasService.prototype.getNoticia = function () {
        return this.noticia;
    };
    NoticiasService.ctorParameters = function () { return [
